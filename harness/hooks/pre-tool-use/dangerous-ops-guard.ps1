# dangerous-ops-guard (PreToolUse wrapper, PowerShell)
#
...
try {
    ...
    $PY = Join-Path $LIB "dangerous_ops_guard.py"
    ...
    [Console]::Error.WriteLine("dangerous-ops-guard: wrapper malfunction: " + $_.Exception.Message)
}
exit 0
